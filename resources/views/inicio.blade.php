            ...
            <div class="card-content">
              <div class="card-body text-center">
                ...
                <div class="text-center">
                  <h1 class="mb-2 text-white">Seja Bem vindo! {{\Illuminate\Support\Facades\Auth::user()->name}} </h1>
                  <p class="m-auto w-75">Aqui pode ficar informações estatisticas do sistema.</p>
                </div>
              </div>
            </div>
          </div>
