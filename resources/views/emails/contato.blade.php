                      ...
                      <tr>
                        <td class="x_primary-font x_text" style="word-break: break-word; font-family: Arial,sans-serif; font-size: 14px; color: #333333; line-height: 170%; border-collapse: collapse;">
                          <div id="x_text4" class="x_mktoText">
                            <p style="text-align: justify;"><span style="font-size: 20px; font-weight: 600"> Você recebeu uma nova solicição de contato </span></p>
                            <p style="text-align: justify;"><span style="font-size: 16px;"> <strong>Nome:</strong> {{$nome}}</span></p>
                            <p style="text-align: justify;"><span style="font-size: 16px;"> <strong>Email:</strong> {{$email}}</span></p>
                            <p style="text-align: justify;"><span style="font-size: 16px;"> <strong>Mensagem:</strong> {{$mensagem}}</span></p>
                          </div>
                        </td>
                      </tr>
                      <tr>
