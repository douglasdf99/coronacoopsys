                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="text-left mt-0 mb-3 font-15 text-center">
                                        ...
                                        class="text-danger font-weight-bold">exluir</span> esse <b>produto</b>?
                                    </div>
                                </div>
                                <div class="col-12">
        ...
        methods: {
            ...
            checkForm: function (e) {
              ...
              Swal.fire({
                ...
                html: 'Aguarde enquanto o produto é excluído',
                ...
                axios.post(`/api/produtos/${this.usuario}`, formData2)
                    .then(response => {
                        this.error = 0;
