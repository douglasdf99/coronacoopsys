                  ...
                  <ul class="div-produto collapsible" v-if="resultado.data.length > 0">
                    <li v-for="(result, index) in resultado.data">
                      <div class="row collapsible-header" style="padding: 0" @click="toogleicon(index)">
                        ...
                        <div class="col s6">
                          <p class="nome-cooperativa">{{result.nome ? result.nome.substring(0, 70) : ''}}</p>
                          ...
                          <div class="align-items-center div-checkbox hide-on-med-and-down">
                            ...
                            <label  v-if="result.areas[0].tipo == 'Estadual'">
                              <input type="checkbox" class="filled-in" checked="checked" readonly disabled="disabled"/>
                              <span>Estadual</span>
                            </label>
                            <label  v-else>
          ...
          <div class="row">
            <ul class="pagination">
              ...
              <li class="waves-effect" v-if="pagination.current_page < pagination.lastPage">
                <a class="page-link" href="#" v-on:click.prevent="changePage(pagination.current_page + 1)"> <i
    ...
    <div class="div-geral-1">
      <div class="container">
        <div class="row align-items-center primeira-row">
          ...
          <div class="col l6 m6 s12">
            <p class="sobre">
              Uma grande rede nacional de cooperativas onde você encontra os produtos e serviços que procura. Esse é o
              CooperaBrasil: uma iniciativa do Sistema OCB para conectar cooperativas, sociedade e estimular a
              intercooperação! Uma oportunidade para as pessoas encontrarem produtos e serviços de cooperativas, e ver
