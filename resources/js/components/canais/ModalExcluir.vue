                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="text-left mt-0 mb-3 font-15 text-center">
                                        ...
                                        class="text-danger font-weight-bold">exluir</span> esse <b>canal</b>?
                                    </div>
                                </div>
                                <div class="col-12">
    ...
    export default {
        ...
        methods: {
            ...
            checkForm: function (e) {
              ...
              Swal.fire({
                title: 'Excluindo Canal!',
                html: 'Aguarde enquanto o canal é excluído',
                ...
                axios.post(`/api/canais/${this.usuario}`, formData2)
                    .then(response => {
                        this.error = 0;
