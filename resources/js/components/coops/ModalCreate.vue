                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10">
                            ...
                            <div class="text-center mb-3">
                                <h3 class="mb-2">Nova <b>Cooperativa</b></h3>
                            </div>
                            ...
                            <div class="text-left mt-0">
                                <form id="editaitem" enctype="multipart/form-data" @submit="checkForm"
                                  ...
                                  <div class="form-group">
                                    <div class="controls">
                                      <label >Ramo:</label>
                                      <Select2 v-model="ramo" :options="ramos" />
                                    </div>
                                  </div>
          ...
          mySelectEvent({id, text}){
            ...
            checkForm(e) {
                ...
                Swal.fire({
                  ...
                  html: 'Aguarde enquanto a nova cooperativa é adicionada',
