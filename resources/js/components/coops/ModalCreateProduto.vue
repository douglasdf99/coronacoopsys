                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10">
                            ...
                            <div class="text-center mb-3">
                                <h3 class="mb-2">Novo <b>Produto</b></h3>
                            </div>
          ...
          mySelectEvent({id, text}){
            ...
            checkForm(e) {
                ...
                Swal.fire({
                  ...
                  html: 'Aguarde enquanto o novo produto é adicionado',
                ...
                formData.append('produto_id', this.produto);
                formData.append('coop_id', this.coop.id);

                axios.post('/api/coop_produtos', formData)
                    .then(response => {
                        this.error =0;
