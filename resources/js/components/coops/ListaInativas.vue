                            ...
                            <div class="col-sm-8">
                                <span class="form-inline">
                                  <div class="input-group w-100">
                                    <input type="text" class="form-control" v-model="tableData.search" placeholder="Buscar cooperativas" aria-describedby="button-addon2">
                        ...
                        <div class="table-responsive" style="position: relative">
                            <table class="table table-centered table-hover mb-0" v-if="pagination.total">
                                ...
                                <tr @click="getUsuario(project)">
                                    ...
                                    <td>
                                      <span class="badge badge-success" v-if="project.ativo"> Ativo</span>
                    ...
                    <div class="col-12 ">
                      <div class="media mb-2">
                        ...
                        <div class="media-body mt-50">
                          ...
                          <h6 class="media-heading">Status:    <span class="badge badge-success" v-if="usuario.ativo"> Ativo</span>
                            <span class="badge badge-danger" v-else> Inativo</span></h6>
