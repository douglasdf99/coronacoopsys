                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10">
                            ...
                            <div class="text-center mb-3">
                                <h3 class="mb-2">Excluir <b>Ramo</b></h3>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="text-left mt-0 mb-3 font-15 text-center">
                                        ...
                                        class="text-danger font-weight-bold">exluir</span> esse <b>ramo</b>?
                                    </div>
                                </div>
                                <div class="col-12">
    ...
    export default {
        ...
        methods: {
            ...
            checkForm: function (e) {
              ...
              Swal.fire({
                title: 'Excluindo Ramo!',
                html: 'Aguarde enquanto o ramo é excluído',
                ...
                axios.post(`/api/ramos/${this.usuario}`, formData2)
                    .then(response => {
                        this.error = 0;
